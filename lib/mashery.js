...
function registerClientMethods(){
    ...
    client.registerMethod('fetchSchedEvent', baseURL + '/services/${serviceId}/endpoints/${endpointId}/scheduledMaintenanceEvent', 'GET');
    client.registerMethod('createSchedEvent', baseURL + '/services/${serviceId}/endpoints/${endpointId}/scheduledMaintenanceEvent', 'POST');
    client.registerMethod('updateSchedEvent', baseURL + '/services/${serviceId}/endpoints/${endpointId}/scheduledMaintenanceEvent', 'PUT');
    client.registerMethod('deleteSchedEvent', baseURL + '/services/${serviceId}/endpoints/${endpointId}/scheduledMaintenanceEvent', 'DELETE');    
